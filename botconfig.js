module.exports = {
  ...
  Token: process.env.Token || "OTU1MzY1NTQzOTQ5NTA0NTIz.GLHqsv._8x7zWe7e9KbaxokXSvorXphnpyfI4SmunKzPk", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "955365543949504523", // Discord Client ID
  ...
  Lavalink: {
    ...
    port: 444, // The port that lavalink is listening to. This must be a number!
